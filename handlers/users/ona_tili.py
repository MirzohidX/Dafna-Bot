...
@dp.callback_query_handler(text="ona")
async def english(call : CallbackQuery):

    await call.message.answer("<b>Ona Tili</b> kursi tanlandi.\n"
                              "Marhamat kurs bilan tanishing 👇\n\n🗓Davomiyligi:   Haftasiga 3 marta\n"
                              "📕Samaradorligi:  100+ o’quvchilar talaba bo’lishga erishgan\n🎓O'qituvchi:  Fazliddin Salomov\n"
                              "🛠Tajriba: 4 yil\n"
                              "🏃‍♂️Shiori:  Oldimizda aniq bir maqsad va ishtiyoq bo’lsa har bir ishning iloji bor\n"
