...
@dp.callback_query_handler(text="koreys")
async def english(call : CallbackQuery):

    await call.message.answer("<b>Koreys tili</b> kursi tanlandi.\n"
                              "Marhamat kurs bilan tanishing 👇\n\n🗓Davomiyligi:   Haftasiga 3 marta\n"
                              "📕Samaradorligi:  So'zlashish ustunligi\n🎓O'qituvchi:  Bahriddin Bafoqulov\n"
                              "🛠Tajriba: 1+ yil\n"
                              "🏃‍♂️Shiori:  O'zbek yoshlarini Koreyaga yuborish\n"
