...
@dp.callback_query_handler(text="mental")
async def english(call : CallbackQuery):

    await call.message.answer("<b>Mental Arifmetika</b> kursi tanlandi.\n"
                              ...
                              "🛠Tajriba: 3 yil\n"
                              "🏃‍♂️Shiori:  Kecha orzu, bugun maqsad, ertaga haqiqat.\n"
                              "💳To'lov:  Naxt & Plastik\n💰Narxi: 150.000 so'm/Har oy\n🕒 1 soat 30 daqiqa\n📌 3 ta dars bepul", reply_markup=course_info)
