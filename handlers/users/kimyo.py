...
@dp.callback_query_handler(text="kimyo")
async def english(call : CallbackQuery):

    await call.message.answer("<b>Kimyo</b> kursi tanlandi.\n"
                              "Marhamat kurs bilan tanishing 👇\n\n🗓Davomiyligi:   Haftasiga 3 marta\n"
                              "📕Samaradorligi:  Ma’suliyatli va talabchan o’qituvchi.\n🎓O'qituvchi:  Bekzod To'rayev\n"
                              "🛠Tajriba: 10 yil\n"
                              "🏃‍♂️Shiori:  Men hech qachon yutqazmadim. Yo g’alaba qozondim yoki nimanidir o’rgandim.\n"
