...
async def english(call : CallbackQuery):
    ...
    await call.message.answer("<b>Matematika</b> kursi tanlandi.\n"
                              "Marhamat kurs bilan tanishing 👇\n\n🗓Davomiyligi:   Haftasiga 3 marta\n"
                              "📕Samaradorligi:  50+ o’quvchilar talaba bo’lishga erishgan\n🎓O'qituvchi:  Ramazon Bozorov\n"
                              "🛠Tajriba: 3 yil\n"
                              "🏃‍♂️Shiori:  Haqiqiy o’qituvchi sizni doimiy ravishda tarbiyalaydigan emas, balki o’zingiz bo’lishingizga yordam beradigan o’qituvchidir\n"
                              "💳To'lov:  Naxt & Plastik\n💰Narxi: 250.000 so'm/Har oy\n🕒 2 soat 30 daqiqa\n📌 3 ta dars bepul", reply_markup=course_info)
